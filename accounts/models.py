...
class Profile(models.Model):
    ...
    # socila media
    linkedin = models.URLField(max_length=100,default='https://www.linkedin.com/',null=True,blank=True)
    facebook = models.URLField(max_length=100,default='https://www.facebook.com/',null=True,blank=True)
    twitter = models.URLField(max_length=100,default='https://x.com/',null=True,blank=True)
